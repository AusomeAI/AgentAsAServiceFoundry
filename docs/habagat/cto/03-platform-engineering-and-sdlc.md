...
6. **Decide the autonomy-ramp default** (100% review → 30% → 10%): whether this is a Habagat standard we hold firm on, or negotiable per deal. My recommendation: standard, non-negotiable downward, since it is the primary control against agent-caused-damage liability (doc 05 Q17-Q18).
